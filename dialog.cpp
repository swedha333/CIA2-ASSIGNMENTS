...
{
     QMessageBox::information(this,"c.p.sudharson 212218205058", "This is QMessageBox");
}

void Dialog::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply = QMessageBox::question(this,
                                       "c.p.sudharson 212218205058", "Do You like strawberry?",
...
{
    QMessageBox::StandardButton reply = QMessageBox::question(this,
                                       "c.p.sudharson 212218205058", "This is Custom message",
        ...
        {
            QMessageBox::warning(this,"c.p.sudharson 212218205058","Display the message with warning as YesToAll");
        }
        if(reply == QMessageBox::NoToAll)
        {
            QMessageBox::warning(this,"c.p.sudharson 212218205058","Don't display the message with warning as YesToAll");
        }
        if(reply == QMessageBox::No) {
...
{
    QMessageBox::warning(this,"c.p.sudharson 212218205058", "this is warning message");
